...
<body>
    ...
    <div class="vente">
        <p>
            ...
            Bienvenue sur BDECESI.fr.

            BDECESI Europe Core SARL, BDECESI EU SARL et/ou leurs sociétés affiliées (« BDECESI ») vous fournissent des fonctionnalités de site internet et d'autres produits et services quand vous visitez le site internet BDECESI.fr (le « site internet »), effectuer des achats sur le site Internet, utiliser des appareils, produits et services d'BDECESI, utiliser des applications BDECESI pour mobile, utiliser des logiciels fournis par BDECESI dans le cadre de tout ce qui précède (ensemble ci-après, les « Services BDECESI »). Veuillez consulter notre Notice Protection de vos Informations Personnelles, notre Notice Cookies et notre Notice Annonces publicitaires basées sur vos centres d'intérêt pour comprendre comment nous collectons et traitons vos informations personnelles dans le cadre des Services BDECESI. BDECESI fournit les Services BDECESI et vend des produits selon les conditions définies sur cette page. BDECESI.fr est le nom commercial utilisé par BDECESI.
            ...
            CONDITIONS D'UTILISATION
            Merci de lire ces conditions attentivement avant d'utiliser les Services BDECESI. En utilisant les Services BDECESI, vous acceptez d'être soumis aux présentes conditions. Nous offrons un large panel de Services BDECESI et il se peut que des conditions additionnelles s'appliquent. Quand vous utilisez un Service BDECESI (par exemple, Votre Profil, les Chèques-Cadeaux ou les Applications BDECESI pour mobile), vous êtes aussi soumis aux termes, lignes directrices et conditions applicables à ce Service BDECESI (« Conditions du Service »). Si ces Conditions d'Utilisation entrent en contradiction avec ces Conditions du Service, les Conditions du Service prévaudront.
            ...
            Quand vous utilisez un quelconque Service BDECESI ou que vous nous envoyez des courriers électroniques, SMS ou autres communications depuis vos équipements fixes ou mobiles, vous communiquez avec nous électroniquement. Nous communiquerons avec vous électroniquement par divers moyens, tels que par courrier électronique, SMS, messages de notification dans l'application ou en postant des courriers électroniques ou des communications sur le site internet ou à travers les autres Services BDECESI, tels que notre Gestionnaire de communication. A des fins contractuelles, vous acceptez que tous les accords, informations, divulgations et autres communications que nous vous enverrons électroniquement remplissent toutes les obligations légales des communiquer par écrit, à moins qu'une loi impérative spécifique impose un autre mode de communication.

            2. RECOMMANDATIONS ET PERSONNALISATION

            Dans le cadre des Services BDECESI, nous vous recommanderons des fonctionnalités, des produits et des services, comprenant des publicités de tiers, qui sont susceptibles de vous intéresser, nous identifierons vos préférences et nous personnaliserons votre expérience.

            3. PROPRIETE INTELLECTUELLE, DROIT D'AUTEUR, ET PROTECTION DES BASES DE DONNEES
            Tout le contenu présent ou rendu disponible à travers les Services BDECESI, tels que les textes, les graphiques, les logos, les boutons, les images, les morceaux de musique, les téléchargements numériques, et les compilations de données, est la propriété d'BDECESI, de ses sociétés affiliées ou de ses fournisseurs de contenu et est protégé par le droit luxembourgeois et international de la propriété intellectuelle, d'auteur et de protection des bases de données. La compilation de tout le contenu présent ou rendu disponible à travers les Services BDECESI est la propriété exclusive d'BDECESI et est protégé par le droit luxembourgeois et international de la propriété intellectuelle et de protection des bases de données.

            Vous ne devez pas extraire et/ou réutiliser de façon systématique des parties du contenu de tout Service BDECESI sans notre autorisation expresse et écrite. En particulier, vous ne devez pas utiliser de robot d'aspiration de données, ou tout autre outil similaire de collecte ou d'extraction de données pour extraire (en une ou plusieurs fois), pour réutiliser une partie substantielle d'un quelconque Service BDECESI, sans notre accord express et écrit. Vous ne devez pas non plus créer et/ou publier vos propres bases de données qui comporteraient des parties substantielles (ex : nos prix et nos listes de produits) d'un Service BDECESI sans notre accord express et écrit.

            4. MARQUES DEPOSEES

            Cliquer ici pour voir une liste non exhaustive des marques déposées par BDECESI. Par ailleurs, les graphiques, logos, en-têtes de page, boutons, scripts et noms de services inclus ou rendus disponibles à travers un Service BDECESI sont des marques ou visuels d'BDECESI. Les marques et visuels d'BDECESI ne peuvent pas être utilisés pour des produits ou services qui n'appartiennent pas à BDECESI, ou d'une quelconque manière qui pourrait provoquer une confusion parmi les clients, ou d'une quelconque manière qui dénigre ou discrédite BDECESI. Toutes les autres marques qui n'appartiennent pas à BDECESI et qui apparaissent sur un quelconque Service BDECESI sont la propriété de leurs propriétaires respectifs, qui peuvent, ou non, être affiliés, liés ou parrainés par BDECESI.

            5. BREVETS

            Un ou plusieurs brevets détenus par BDECESI s'appliquent aux Services BDECESI, à ce site internet et aux fonctionnalités et services accessibles via le site internet et les Services BDECESI. Des parties de ce site internet fonctionnent sous licences d'un ou plusieurs brevets. Cliquer ici pour voir une liste non exhaustive des brevets détenus par BDECESI et des licences de brevets applicables.

            6. LICENCE ET ACCES

            Sous réserve du respect des présentes Conditions d'Utilisation et des Conditions des Services et du paiement de tous les sommes applicables, BDECESI ou ses fournisseurs de contenu vous accorde une licence limitée, non exclusive, non transférable, non sous licenciable pour l'accès et à l'utilisation personnelle et non commerciale des Services BDECESI. Cette licence n'inclut aucun droit d'utilisation d'un Service BDECESI ou de son contenu pour la vente ou tout autre utilisation commerciale ; de collecte et d'utilisation d'un listing produit, descriptions, ou prix de produits; de toute utilisation dérivée d'un Service BDECESI ou de son contenu ; de tout téléchargement ou copie des informations d'un compte pour un autre commerçant ; ou de toute utilisation de robot d'aspiration de données, ou autre outil similaire de collecte ou d'extraction de données.

            Tous les droits qui ne vous ont pas été expressément accordés dans ces Conditions d'Utilisation ou dans les Conditions d'un Service sont réservés et restent à BDECESI ou à ses licenciés, fournisseurs, éditeurs, titulaires de droits, ou tout autre fournisseur de contenu. Aucun Service BDECESI ou tout ou partie de celui-ci ne doit être reproduit, copié, vendu, revendu, visité ou exploité pour des raisons commerciales sans notre autorisation expresse et écrite.

            Vous ne devez pas cadrer ou utiliser des techniques de cadrage (framing) pour insérer toute marque, logo ou autre information commerciale (y compris des images, textes, mises en pages ou formes) d'BDECESI sans notre autorisation expresse et écrite. Vous ne devez pas utiliser de méta tags ou tout autre « texte caché » utilisant le nom ou les marques déposées d'BDECESI sans notre autorisation expresse et écrite.

            Vous ne devez pas faire un mauvais usage d'un Service BDECESI. Vous devez utiliser les Services BDECESI comme autorisé par la loi. Les licences accordées par BDECESI prendront fin si vous ne respectez pas ces Conditions d'Utilisation ou les Conditions des Services.

            7. VOTRE COMPTE

            Vous pouvez avoir besoin d'un compte personnel BDECESI pour utiliser certain Services BDECESI, et il peut vous être demandé de vous connecter au compte et d'avoir une méthode de paiement valide associée à celui-ci. En cas de problème pour utiliser la méthode de paiement que vous avez sélectionnée, nous pourrons utiliser toute autre méthode de paiement valide associée à votre compte. Cliquez ici pour gérer vos options de paiement.

            Si vous utilisez un quelconque Service BDECESI, vous êtes responsable du maintien de la confidentialité de votre compte et mot de passe, des restrictions d'accès à votre ordinateur et autres équipements, et dans la limite de ce qui est autorisé par la loi applicable, vous acceptez d'être responsable de toutes les activités qui ont été menées depuis de votre compte ou avec votre mot de passe. Vous devez prendre toutes les mesures nécessaires pour vous assurer que votre mot de passe reste confidentiel et sécurisé, et devez nous informer immédiatement si vous avez des raisons de croire que votre mot de passe est connu de quelqu'un d'autre, ou si le mot de passe est utilisé ou susceptible d'être utilisé de manière non autorisée. Vous êtes responsable de la validité et du caractère complets des informations que vous nous avez fournies, et devez nous informer de tout changement concernant ces informations. Vous pouvez accéder à vos informations dans la section Votre compte du site internet. Veuillez consulter nos pages d'aide relatives à la Protection de vos informations personnelles pour accéder à vos informations personnelles.

            Vous ne devez pas utiliser un quelconque Service BDECESI : (i) d'une façon qui causerait, ou serait susceptible de causer une interruption, un dommage, ou une altération d'un Service BDECESI, or (ii) dans un but frauduleux, ou en relation avec un crime ou une activité illégale, ou (iii) dans le but provoquer des troubles, nuisances ou causes d'anxiétés.

            Nous nous réservons le droit de refuser l'accès, de fermer un compte, de retirer ou de modifier du contenu si vous êtes en violation des lois applicables, de ces Conditions d'utilisation ou tous autres termes, conditions, lignes directrices ou politique d'BDECESI.

            8. COMMENTAIRES, CRITIQUES, COMMUNICATIONS ET AUTRE CONTENU

            Les visiteurs peuvent mettre en ligne des revues, des commentaires ou tout autre contenu ; envoyer des cartes électroniques ou autres communications, et soumettre des suggestions, des idées, des questions ou toute autre information tant que ce contenu n'est pas illégal, obscène, abusif, menaçant, diffamatoire, calomnieux, contrevenant aux droits de propriété intellectuelle, ou préjudiciable à des tiers ou répréhensible et ne consiste pas ou ne contient pas de virus informatiques, de militantisme politique, de sollicitations commerciales, de chaînes de courriers électroniques, de mailing de masse ou toute autre forme de « spam ». Vous ne devez pas utiliser une fausse adresse e-mail, usurper l'identité d'une personne ou d'une entité, ni mentir sur l'origine d'une carte de crédit ou d'un contenu. Nous nous réservons le droit (sans aucune obligation en l'absence d'un Formulaire de Notification valide), de retirer ou de modifier tout contenu. Si vous pensez qu'un contenu ou une annonce de vente sur un quelconque Service BDECESI contient un message diffamatoire, ou que vos droits de propriété intellectuelle ont été enfreints par un article ou une information sur le site internet, merci de nous le notifier en complétant le Formulaire de Notification adéquat, et nous y répondrons.

            Si vous publiez des commentaires clients, , des questions / réponses ou tout autre contenu généré par vous pour être publié sur le site internet (incluant toute image, vidéo ou enregistrement audio, ensemble le « contenu ») , vous accordez à BDECESI, (i) une licence non-exclusive et gratuite pour utiliser, reproduire, , publier, rendre disponible, traduire et modifier ce contenu dans le monde entier(incluant le droit de sous-licencier ces droits à des tiers); et (b) le droit d'utiliser le nom que vous avez utilisé en lien avec ce contenu. Aucuns droits moraux ne sont transférés par l'effet de cette clause.

            Vous pouvez supprimer votre contenu de la vue du public ou, lorsque cette fonctionnalité est offerte, modifier les paramètres pour qu'il ne soit visible que par les personnes auxquelles vous en avez donné l'accès. Vous déclarez et garantissez être propriétaire ou avoir les droits nécessaires sur le contenu que vous publiez ; que, à la date de publication du contenu ou du matériel : (i) le contenu et le matériel est exact, (ii) l'utilisation du contenu et du matériel que vous avez fourni ne contrevient pas à l'une des procédures ou lignes directrices d'BDECESI et ne portera pas atteinte à toute personne physique ou morale (notamment que le contenu ou le matériel ne sont pas diffamatoires). Vous acceptez d'indemniser BDECESI en cas d'action d'un tiers contre BDECESI en lien avec le contenu ou le matériel que vous avez fourni, sauf dans le cas où l'éventuelle responsabilité d'BDECESI pourrait être recherchée pour ne pas avoir retiré un contenu dont le caractère illicite lui aurait été notifié (Formulaire de Notification), dès lors que cette action aurait pour cause, fondement ou origine le contenu que vous nous avez communiqué.

            9. REVENDICATIONS DE PROPRIETE INTELLECTUELLE

            BDECESI respecte la propriété intellectuelle d'autrui. Si vous pensez qu'un de vos droits de propriété intellectuelle a été utilisé d'une manière qui puisse faire naitre une crainte de violation desdits droits, merci de suivre notre Procédure et formulaire de notification de violation de droits.

            10. CONDITIONS LOGICIEL BDECESI

            S'ajoute à ces Conditions d'Utilisation, les conditions suivantes qui s'appliquent à tous les logiciels (en ce compris les mises à jour ou les évolutions du logiciel et de toute la documentation liée) que nous vous rendons disponibles pour votre utilisation des Services BDECESI (ci-après « Logiciels BDECESI »).

            11. AUTRES ENTREPRISES

            Des tiers autres qu'BDECESI gèrent des boutiques, proposent des services et vendent des lignes de produits sur ce site internet. De surcroit, nous fournissons des liens vers des sites internet de société affiliées et d'un certain nombre d'entreprises. Nous ne sommes pas responsables de l'examen ou de l'évaluation, et nous ne garantissons pas les offres de ces entreprises ou de ces particuliers, ou le contenu de leurs sites internet. BDECESI n'assume aucune responsabilité ou obligation pour les actes, produits ou contenu de ces entreprises ou de ces particuliers ou d'autres tiers. Vous êtes informés quand un tiers est impliqué dans votre transaction, et nous pouvons partager vos informations en lien avec cette transaction avec ce tiers. Vous devez examiner leurs politiques de confidentialité et autres conditions d'utilisation avec attention.

            12. ROLE D'BDECESI

            BDECESI permet à des vendeurs tiers de lister et de vendre leurs produits sur BDECESI.fr. Dans chacun de ces cas, ceci est indiqué sur la page respective de détail du produit. Bien qu'BDECESI, en tant qu'hébergeur, facilite les transactions réalisées sur la place de marché (ou Marketplace) d'BDECESI, BDECESI n'est ni l'acheteur ni le vendeur des produits des vendeurs tiers. BDECESI fournit un lieu de rencontre dans lequel les acheteurs et vendeurs complètent et finalisent leurs transactions. En conséquence, pour la vente de ces produits de vendeurs tiers, un contrat de vente est formé uniquement entre l'acheteur et le vendeur tiers. BDECESI n'est pas partie à un tel contrat et n'assume aucune responsabilité ayant pour origine un tel contrat ou découlant de ce contrat de vente. BDECESI n'est ni l'agent ni le mandataire des vendeurs tiers. Le vendeur tiers est responsable des ventes de produits et des réclamations ou tout autre problème survenant ou lié au contrat de vente entre lui et l'acheteur. Parce qu'BDECESI souhaite que l'acheteur bénéficie d'une expérience d'achat la plus sûre, BDECESI offre la Garantie A à Z en plus de tout droit contractuel ou autre.

            13. NOTRE RESPONSABILITE

            Nous ferons de notre mieux pour assurer la disponibilité des Services BDECESI et que les transmissions se feront sans erreurs. Toutefois, du fait de la nature d'internet, ceci ne peut être garanti. De plus, votre accès aux Services BDECESI peut occasionnellement être suspendu ou limité pour permettre des réparations, la maintenance, ou ajouter une nouvelle fonctionnalité ou un nouveau service. Nous nous efforcerons de limiter la fréquence et la durée de ces suspensions ou limitations.

            Dans le cadre de ses relations avec des professionnels, BDECESI n'est pas responsable (i) des pertes qui n'ont pas été causées par une faute de notre part, ou (ii) des pertes commerciales (y compris les pertes de profit, bénéfice, contrats, économies espérées, données, clientèle ou dépenses superflues), ou (iii) toute perte indirecte ou consécutive qui n'étaient pas prévisibles par vous et nous quand vous avez commencé à utiliser le Service BDECESI.
            ...
            Nous ne vendons pas de produits aux mineurs. Nous vendons des produits pour enfants pour des achats par des adultes. Si vous avez moins de 18 ans, vous ne pouvez utiliser un Service BDECESI que sous la surveillance d'un parent ou d'un tuteur. Les offres de produits contenant de l'alcool sont destinées à des personnes majeures. Vous devez avoir au moins 18 ans pour acheter de l'alcool ou utiliser toute fonctionnalité du site concernant de l'alcool.

            18. NOS COORDONNEES

            Le site internet BDECESI.fr appartient à, et sa maintenance est effectuée par, BDECESI Europe Core SARL. Des conditions spécifiques d'utilisation et de vente pour d'autres Services BDECESI, par exemple le service Musique MP3 géré par BDECESI Media EU SARL, peuvent être trouvées sur le site internet.

            Pour BDECESI Europe Core SARL :

            BDECESI Europe Core SARL, Société à responsabilité limitée, 38 avenue John F. Kennedy, L-1855 Luxembourg
            ...
            Pour BDECESI EU, Société à responsabilité limitée :
            BDECESI EU, Société à responsabilité limitée, 38 avenue John F. Kennedy, L-1855 Luxembourg
            ...
            BDECESI EU SARL, succursale française, 67 Boulevard du General Leclerc, Clichy 92110, France
            ...
            Pour BDECESI Services Europe SARL :
            BDECESI Services Europe SARL, Société à responsabilité limitée, 38 avenue John F. Kennedy, L-1855 Luxembourg
            Capital social : 37 500 €
            Enregistrée au Luxembourg
            ...
            Pour BDECESI Media EU SARL :
            BDECESI Media EU SARL, Société à responsabilité limitée, 38 avenue John F. Kennedy, L-1855 Luxembourg
            Capital social : 37 500 €
            Enregistrée au Luxembourg
            ...
            Si vous pensez que vos droits ont été violés et que vous êtes éligible aux Registre des Marques, veuillez vous inscrire au service et soumettre votre plainte via le Registre des Marques. Sinon, merci d'utiliser notre Formulaire de Notification. Ce formulaire peut être utilisé pour nous soumettre toute sorte de plainte de propriété intellectuelle y compris, sans toutefois s'y limiter, les plaintes liées aux droits d'auteur, de marques, de dessins et modèles et de brevets. Dès réception d'un Formulaire de Notification, nous pouvons prendre certaines mesures, notamment la suppression d'informations ou d'un article et mettre fin aux infractions répétées dans des circonstances appropriées. Ces mesures seront toutefois prises sous toutes réserves, sans reconnaissance de notre part d'une responsabilité quelconque et sans préjudice de l'exercice de nos droits, actions et moyens de défense. Ceci comprend également le transfert de ce formulaire aux parties concernées par l'infraction alléguée. Vous acceptez d'indemniser BDECESI contre toute réclamation de tiers contre BDECESI, découlant de, ou dans le cadre de cette notification.

            Note concernant les offres des vendeurs tiers : merci de garder à l'esprit que les offres des vendeurs tiers sont seulement hébergées sur BDECESI.fr et sont publiées uniquement sous la direction des vendeurs tiers qui peuvent être contactés par leur page « Informations sur le vendeur », accessible depuis toutes leurs offres.

            Définition d'ASIN et de ISBN-10 : « ASIN » signifie BDECESI Standard Item (or Identification) Number (Numéro d'identification ou d'article standard d'BDECESI) et est un identifiant composé de dix (10) caractères. Ce numéro figure dans toute fiche descriptive d'un produit sous le titre « Détails sur le produit ». « ISBN-10 » signifie International Standard Book Number (Numéro de livre standard international) et est un identifiant composé de dix (10) chiffres figurant sur certaines fiches descriptives de livres dans la catégorie « Détails sur le produit ».

            Avertissement important : fournir des informations inexactes, trompeuses ou fausses dans un Formulaire de Notification adressé à BDECESI engage sa responsabilité civile et/ou pénale. En cas de doute, veuillez contacter un conseiller juridique..

            Formulaire de notification : Si vous souhaitez nous notifier la violation de vos droits en relation avec une offre de produit disponible sur le site www.BDECESI.fr, nous vous invitons à remplir le Formulaire de notification disponible en cliquant sur le lien ci-dessous :

            https://www.BDECESI.fr/gp/help/reports/infringement

            20. PROCEDURE ET FORMULAIRE DE NOTIFICATION EN VUE DE NOTIFIER UN CONTENU INJURIEUX OU DIFFAMATOIRE

            Parce que des millions de produits sont listés et que des milliers de commentaires sont hébergés sur BDECESI.fr, il ne nous est pas possible de connaître le contenu de tous les produits offerts à la vente, ou de tous les commentaires ou critiques qui sont affichés. En conséquence, nous opérons sous un système de « notice and action » soit « notifier et action ». Si vous pensez qu'un contenu ou une annonce de vente sur le site internet contient un message diffamatoire, merci de nous le notifier immédiatement en complétant la Procédure et le Formulaire de notification en vue de notifier un contenu injurieux ou diffamatoire. Suivez les instructions dans le formulaire de Notification.

            Avertissement important : fournir des informations inexactes, trompeuses ou fausses dans la Notification adressée à BDECESI peut engager votre responsabilité civile et/ou pénale.

            La procédure de notification : Merci de nous envoyer le formulaire ci-dessous, dûment rempli et signé, à l'adresse suivante : Département juridique, NTD, BDECESI EU S.à r.l., 38 avenue John F. Kennedy, L-1855 Luxembourg, Grand Duché du Luxembourg.
            ...
            1. Je fais référence au site www.BDECESI.fr. Ce dernier affiche ou contribue à l'affichage de commentaires injurieux ou diffamatoires à mon sujet.

            2. Les propos injurieux ou diffamatoires (RAYEZ LE PARAGRAPHE INUTILE) :
            (a) apparaissent dans un livre vendu sur le site www.BDECESI.fr :
            ...
            (b) apparaissent sur le site www.BDECESI.fr à l'adresse suivante: _______________________ (ADRESSE EXACTE DE LA PAGE WEB)
            ...
            (1) « ASIN » signifie « BDECESI Standard Item (or Identification) Number » (Numéro d'identification ou d'article standard d'BDECESI) et représente un identifiant propre à BDECESI.fr composé de dix (10) caractères. Ce numéro figure dans toute fiche descriptive d'un produit sous le titre « Détails sur le produit ».
            ...
            CONDITIONS ADDITIONNELLES DES LOGICIELS BDECESI

            1. Utilisation des Logiciels BDECESI.

            Vous pouvez utiliser les Logiciels BDECESI aux seules fins de vous permettre d'utiliser et de profiter des Services BDECESI tels que fournis par BDECESI, et tels qu'autorisé par les Conditions d'utilisation, des présentes Conditions Logiciel BDECESI, et des Conditions des Services. Il est interdit d'intégrer tout ou partie d'un Logiciel BDECESI dans vos propres programmes, de compiler tout ou partie d'un Logiciel BDECESI avec vos propres programmes, de transférer tout ou partie d'un Logiciel BDECESI pour l'utiliser avec un autre service ou de vendre, louer, prêter, distribuer ou sous-licencier tout ou partie d'un Logiciel BDECESI ou transférer un quelconque droit sur tout ou partie de ce Logiciel BDECESI. Vous ne pouvez utiliser les Logiciels BDECESI à des fins illégales. Nous nous réservons le droit de mettre fin à toute utilisation d'un Logiciel BDECESI et de vous retirer les droits d'utilisation d'un Logiciel BDECESI à tout moment. Si vous ne respectez pas les présentes Conditions Logiciel BDECESI, les Conditions d'utilisation et toutes Conditions des Services BDECESI, les droits d'utilisation d'un Logiciel BDECESI qui vous sont accordés vous seront automatiquement retirés sans notification préalable. Des conditions supplémentaires définies par des tiers et contenues ou distribuées avec certains Logiciels BDECESI et spécifiquement identifiées dans la documentation connexe peuvent être applicables à ces Logiciels BDECESI (ou logiciels intégrés dans un Logiciel BDECESI) et prévaudront en cas de conflit avec les présentes Conditions d'utilisation. Tout logiciel utilisé dans un quelconque Service BDECESI est la propriété d'BDECESI ou de ses fournisseurs de logiciels et est protégé par les lois luxembourgeoises et internationales sur la protection des programmes d'ordinateur et du copyright.

            2. Utilisation de services tiers.

            Lorsque vous utilisez un Logiciel BDECESI, vous pouvez également être amené à utiliser les services d'un ou plusieurs tiers, tels que ceux d'un opérateur mobile ou d'un fournisseur de plateforme mobile. L'utilisation de ces services tiers peut être soumise aux politiques, conditions d'utilisation et à des frais de ces tiers.

            3. Interdiction d'ingénierie inverse.

            Vous ne pouvez et vous n'encouragerez pas, ni n'assisterez ou n'autoriserez qui que ce soit à (i) copier, modifier, altérer d'une autre façon un Logiciel BDECESI en tout ou partie, créer des œuvres dérivées à partir ou du Logiciel BDECESI ou (ii) effectuer de l'ingénierie inverse, décompiler ou désassembler un Logiciel BDECESI en tout ou partie, sauf dans les limites autorisées par la loi.

            4. Mises à jour.

            Afin de garder les Logiciels BDECESI à jour, nous pouvons offrir des mises à jour automatiques ou manuelles à tout moment et sans notification préalable.

            CONDITIONS GENERALES DE VENTE
            Bienvenue sur le site BDECESI.fr.

            BDECESI EU SARL et/ou ses sociétés affiliées (« BDECESI ») vous fournissent des fonctionnalités de site internet et d'autres produits et services quand vous visitez ou achetez sur le site internet BDECESI.fr (le « Site Internet »), utilisez des produits et services d'BDECESI, utiliser des applications BDECESI pour mobile, ou utiliser des logiciels fournis par BDECESI dans le cadre de tout ce qui précède (ensemble ci-après, les « Services BDECESI »). BDECESI fournit les Services BDECESI selon les conditions définies dans cette page.

            Ces Conditions Générales de Vente régissent la vente de produits entre BDECESI EU SARL et vous. Pour les conditions relatives à la vente entre vous et des vendeurs tiers sur le Site Internet BDECESI.fr, veuillez prendre connaissance du Contrat BDECESI Services Europe Business Solutions. Nous offrons un large panel de Services BDECESI et il se peut que des conditions additionnelles s'appliquent. Par ailleurs, lorsque vous utilisez un Service BDECESI (par exemple votre Profil, les Chèques-Cadeaux, les applications pour mobile ou le Gestionnaire de communication), vous êtes également soumis aux termes, lignes directrices et conditions applicables à ce Service BDECESI (les « Conditions du Service »). Si ces Conditions Générales de Ventes entrent en contradiction avec les Conditions du Service, les Conditions du Service prévaudront.

            Merci de lire ces conditions attentivement avant d'effectuer une commande avec BDECESI EU SARL. En commandant avec BDECESI EU SARL, vous nous notifiez votre accord d'être soumis aux présentes conditions.
            ...
            Les produits livrés restent la propriété d'BDECESI jusqu'à leur remise au transporteur.
            ...
            la fourniture de services pleinement exécutés par BDECESI pour lesquels vous avez accepté au moment de la passation de votre commande que nous commencions leur exécution, et renoncé à votre droit de rétractation ;
            ...
            Nous ne vendons pas de produits aux mineurs. Nous vendons des produits pour enfants pour des achats par des adultes. Si vous avez moins de 18 ans, vous ne pouvez utiliser le Site Internet BDECESI.fr que sous la surveillance d'un parent ou d'un tuteur.

            12. IDENTIFICATION

            BDECESI.fr est une marque commerciale utilisée par BDECESI EU SARL. Nos informations de contact sont les suivantes :
